...
public class MyBookingGuideController implements Initializable{
    public VBox vbox;
    ...
    public void goUserEdit(ActionEvent actionEvent) throws IOException{
        ...
        private void loadBookings(List<Booking> bookings) {
            ...
            bookingContainer.setPadding(new Insets(20));
            if(bookings==null){
                return;
            }
            for (Booking booking : bookings) {
                ...
                try {
                    ...
                    attractionDesc=Objects.requireNonNull(ObjectFinder.getAttraction(booking.getAid())).getDescription();
                } catch (Exception e) {
                    attractionName = "Unknown Attraction";
                    attractionDesc="Nothing";
                }
                ...
                Label description = new Label(bundle.getString("guideBookingCardDesc")+": "+attractionDesc);
        ...
        private void handleCancel(Booking booking) throws IOException {
            ...
            CacheHandler.ClearCache();
            Navigator.Navigate(NAVIGATIONS.GUIDEPAGE, (Stage) bookingContainer.getScene().getWindow());
        }
